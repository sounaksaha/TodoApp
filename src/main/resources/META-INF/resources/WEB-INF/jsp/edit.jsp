...
<body>
	<div class="container">
		<h4 id="logo">Edit Todo</h4>
		<form action="/update" method="post">
			<div class="user__details">
				<div class="input__box">
					<label for="description" class="form-label">Description</label> <input
						type="text" class="form-control" id="description"
						name="description" value="${todo.description}" required="required"
						placeholder="Enter a description for your task">
				</div>
				<div class="input__box">
					<label for="targetdate" class="form-label">Target Date</label> <input
						type="date" class="form-control" id="targetdate"
						required="required" value="${todo.targetdate}" name="targetdate">
				</div>
				<div class="input__box">
					<label for="time" class="form-label">Time (12-Hour Format)</label>
					<div class="input-group clockpicker">
						<input type="text" class="form-control" id="time" name="time"
							value="${todo.time }" required="required"
							placeholder="HH:MM AM/PM" /> <span class="input-group-addon">
